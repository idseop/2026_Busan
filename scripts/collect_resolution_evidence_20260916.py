...
def analyze():
 ...
 md=['# 소방 불량기록 후속시정과 AED 공개기준 재검토','','2026-09-16 기준. 원자료를 반복집계하지 않고 미확인 후속조치와 공개정보의 의미를 추가 확인했다.','','## 결과','','- 기존불량19행: 현지시정기재6·비고 공란13 유지. 새 시정완료·재점검결과와 일치하는 공개기록은 확보하지 못했다. 현재불량지속19행이라는뜻이 아니다. 일반 비고란이며 조치완료 전용열이 없고 금정 판정25행·부산진34행 전체가 공란이므로 불량13행만의 정보관리 공백도 아니다.','- 공식3서게시본문에서9/1~16 시정·재점검·행정처분·조치결과를검색했다.12검색중10개0건,2개는동일 데이터센터 사전계획1건이었다. 직접원문을열어9/22예정 별도조사임을확인하고제외했다.','- 개별민감시설명·개인명의건물주소를새공개목록으로만들지않았다. 내부연결키는소방서+원문행번호다. 첨부전체·비공개대장·기관전체를검색했다고주장하지않는다.','','## 새로 확인된 AED 결과','','보건복지부2026.3 제8판을 공식구청배포 HWPX로확보했다. 부산운영실적이아니라전국공통 관리·외부표출 정의에만쓴다.']
