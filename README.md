...
> ## 🚨 작업 전에 **[CONTRIBUTING.md](CONTRIBUTING.md) 를 먼저 읽으세요**
> 
> 브랜치·커밋·PR·충돌 방지 규칙이 들어 있습니다. **읽지 않으면 서로의 작업을 덮어씁니다.**
> 특히 이 셋은 모르면 사고가 납니다:
> - `main` 직접 push 금지 (두 겹으로 차단돼 있습니다)
> - 클론 후 `git config core.hooksPath .githooks` 1회 실행
> - 노트북은 **출력을 clear** 하고 커밋
